    ...
    try:
        ...
        if scf.cf.link_uri == URI_Leader:   
            ...
            while en_cours:
                ...
                att = interactions.compute_attraction_force(pos_dict, scf.cf.link_uri, 0.60, 0.5, False)
                rep = interactions.compute_repulsion_force(pos_dict, scf.cf.link_uri, 0.70, 1.0, False)
